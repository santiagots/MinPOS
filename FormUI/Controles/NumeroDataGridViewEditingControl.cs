...
namespace FormUI.Controles
{
    ...
    class TNumEditDataGridViewEditingControl : NumeroTextBox, IDataGridViewEditingControl
    {
    ...
    public class NumeroDataGridViewColumn : DataGridViewTextBoxColumn
    {
        private const int m_allowMaxDecimalLength = 6;

        public NumeroDataGridViewColumn()
        {
    ...
    public class TNumEditDataGridViewCell : DataGridViewTextBoxCell
    {
        ...
        internal void SetDecimalLength(int rowIndex, int value)
        {
            ...
            {
                this.EditingTNumEditBox.CantidadDecimales = value;
            }
        }
        ...
        internal void EnableNegative(int rowIndex, bool value)
        {
            ...
            if (OwnsEditingControl(rowIndex))
            {
                this.EditingTNumEditBox.PermiteNegativos = value;
            }
        }
